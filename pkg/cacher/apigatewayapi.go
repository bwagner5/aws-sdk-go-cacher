...
import (
	...
	"github.com/aws/aws-sdk-go/service/gateway"
	"github.com/aws/aws-sdk-go/service/gateway/gatewayiface"
...
type APIGateway struct {
	gatewayiface.APIGatewayAPI
	cache *cache.Cache
}

func NewAPIGateway(gatewayapi gatewayiface.APIGatewayAPI) *APIGateway {
	return &APIGateway{
		APIGatewayAPI: gatewayapi,
