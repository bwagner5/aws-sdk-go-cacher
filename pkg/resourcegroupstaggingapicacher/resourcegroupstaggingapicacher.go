...
*/
package resourcegroupstaggingapicacher
...
func New(resourcegroupstaggingapiapi resourcegroupstaggingapiiface.ResourceGroupsTaggingAPIAPI) *ResourceGroupsTaggingAPI {
	return &ResourceGroupsTaggingAPI{
		ResourceGroupsTaggingAPIAPI: resourcegroupstaggingapiapi,
