...
*/
package redshiftdataapiservicecacher
...
func New(redshiftdataapiserviceapi redshiftdataapiserviceiface.RedshiftDataAPIServiceAPI) *RedshiftDataAPIService {
	return &RedshiftDataAPIService{
		RedshiftDataAPIServiceAPI: redshiftdataapiserviceapi,
